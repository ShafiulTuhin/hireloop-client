...
export default function CreateJob({ company }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-[#0b1220] text-white py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-b border-zinc-800 pb-6 mb-8">
          ...
          {company.status === "pending" && (
            <p className="mt-2 flex items-center gap-2 text-xs text-amber-400">
              ...
              Waiting for admin approval. Your job posting will become visible
